...
public class AuthService {
    ...
    public SignUpResponseDto signUp(SignUpRequestDto requestDto) throws CustomException {
    ...
    public SessionQrResponse generateSessionQR(HttpServletRequest request) throws CustomException {
        ...
        try {
            var image = QRUtil.generateQRCodeImage(session.getId(), 200, 200);
    ...
    public ConfirmSessionResponseDto confirmSession(@RequestBody ConfirmSessionRequestDto confirmRequestDto, HttpServletRequest request) throws CustomException {
        ...
        QRSession session = qrSessionRepository.findById(confirmRequestDto.getSessionId()).orElseThrow(() -> new CustomException(ErrorCode.REFRESH_TOKEN_NOT_FOUND));
    ...
    public SessionStatusResponseDto sessionStatus(HttpServletRequest request, HttpServletResponse response) throws CustomException {
        QRSession session = qrSessionRepository.findById(request.getSession().getId()).orElseThrow(() -> new CustomException(ErrorCode.REFRESH_TOKEN_NOT_FOUND));
